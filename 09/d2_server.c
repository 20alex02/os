 ...
 * spolupracuje s klientem z ukázky ‹07/d1_client›. Server se
 * vyznačuje dvěma vlastnostmi:
 *
 ...
 *     souběžně (v této ukázce se ale omezíme na sekvenční
 *     odbavování klientů).
 *
...
int main( int argc, const char **argv )
{
    ...
    /* První část serveru je shodná s klientem – vytvoříme socket ve
     * správné doméně a správného typu. */
     ...
     * volání ‹unlink› (které známe z 6. kapitoly). Nepodaří-li se
